            ...
            <div className="h-auto md:h-[65vh] w-[90vw] md:w-[80vw] bg-white rounded-[20px] overflow-hidden shadow-lg mx-2 md:mx-6 my-6 flex flex-col md:flex-row">
              <div className="w-full md:w-[70%] h-auto md:h-[65vh] rounded-l-[20px] p-4 md:pl-12 md:pr-20 md:pb-10">
                <div className="h-auto md:h-[10vh] w-full px-2 md:px-5 flex items-center justify-between md:justify-evenly">
                  ...
                  <p className="text-lg md:text-[30px] text-gray-500 mt-4">{data.data.data.seat} Class</p>
                </div>
                ...
                <div className="flex flex-col md:flex-row justify-center items-center gap-4 md:gap-40 mb-2 mt-4">
                  <div className="flex flex-col justify-center items-center">
                    ...
                    <div className="font-bold text-lg md:text-2xl">{data.data.data.flightName}</div>
                  </div>
                  <div className='flex flex-col justify-center items-center'>
                  ...
                  <div className='flex flex-col justify-center items-center'>
                    ...
                    <div className="font-bold text-lg md:text-2xl">{data.data.data.destinationAirport}</div>
                  </div>
                </div>
                <div className="flex flex-col md:flex-row justify-between mb-2 mt-6 gap-4 md:gap-0">
                  ...
                  <div className="flex flex-col justify-center items-center w-full md:w-32">
                    ...
                    <div className="font-bold text-lg md:text-2xl text-center">{timeDifference(data.data.data.departureTime, data.data.data.arrivalTime)}</div>
                  </div>
                </div>
                <div className="flex flex-col md:flex-row justify-between mt-6 gap-4 md:gap-0">
                  <div className="flex flex-col justify-center items-center">
                    ...
                    <div className="font-bold text-lg md:text-xl text-black">{formatDate(formatDateTime(data.data.data.departureTime)[0])}</div>
                    <div className="font-semibold text-xl md:text-3xl">{formatDateTime(data.data.data.departureTime)[1]}</div>
                  </div>
                  <div className='flex flex-col justify-center items-center'>
                    <div className="font-normal text-sm md:text-lg text-gray-500">ARRIVAL</div>
                    <div className="font-bold text-lg md:text-xl text-black">{formatDate(formatDateTime(data.data.data.arrivalTime)[0])}</div>
                    <div className="font-semibold text-xl md:text-3xl">{formatDateTime(data.data.data.arrivalTime)[1]}</div>
                  </div>
                  <div className='flex flex-col justify-center items-center'>
                    <div className="font-normal text-sm md:text-lg text-gray-500">FLIGHT NO</div>
                    <div className="font-bold text-lg md:text-2xl">{data.data.data.flightNumber}</div>
                  </div>
                </div>
              </div>
